...
# @Last Modified time: 2015-08-06 16:34:18
...
# as in the example:
compatible_with_SSM = "answer"
# Whatever you answered, please replace the following 0 with the distance
# between the average of the observations and the expected value (1),
# in units of standard deviations. Round to the nearest integer.
distance = 0
